 ...
 */
public class RESOLVEASTFactory extends CoreASTFactory {
     ...
     */
    @NotNull @Override public CompositeElement createComposite(
            IElementType type) {
     ...
     */
    @NotNull @Override public LeafElement createLeaf(@NotNull IElementType type,
